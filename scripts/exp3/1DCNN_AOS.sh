...
# data config
declare -a data_flag_list=("DatabyTable") 
declare -a data_splitting_method_list=("AOS") # "AOS" "PS" "LOSO"
declare -a subjects_list=("C") # "A" "B" "C"
declare -a downsampling_rate_options=(10) 

# model config
declare -a model_type_options=("1dcnn") # "1dcnn" "1dsepcnnfused" 
declare -a num_blocks_options=(4) 
p=0  # dropout
